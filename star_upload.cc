...
//                                 \   /
//                                  \ /
//n1(echoserver)ㅡㅡ (10.1.1.0) ㅡ ㅡ n0 ㅡ ㅡ (10.1.4.0) ㅡ ㅡ n4
//                                  /  \
//                                 /    \
//                         (10.1.6.0)  (10.1.5.0)     
//                               /        \
...
devices1.Add(pointToPoint.Install(node0,p2pNodes.Get(1)));
devices2.Add(pointToPoint.Install(node0,p2pNodes.Get(2)));
devices3.Add(pointToPoint.Install(node0,p2pNodes.Get(3)));
devices4.Add(pointToPoint.Install(node0,p2pNodes.Get(4)));
devices5.Add(pointToPoint.Install(node0,p2pNodes.Get(5)));
devices6.Add(pointToPoint.Install(node0,p2pNodes.Get(6)));
...
//////// Your Code ////////
  UdpEchoClientHelper echoClient1 (p2pInterfaces01.GetAddress (1),9);
...
//////// Your Code ////////
  ApplicationContainer clientApps1 = echoClient1.Install (p2pNodes.Get (6));
...
//////// Your Code ////////
  ApplicationContainer clientApps1 = echoClient1.Install (p2pNodes.Get (4));
  clientApps1.Start (Seconds (clientapptime));
...
//////// Your Code ////////
  ApplicationContainer serverApps2 = echoServer2.Install (p2pNodes.Get(5));
  serverApps2.Start (Seconds (1.0));
  serverApps2.Stop (Seconds (simTime));

//////// Your Code ////////
  UdpEchoClientHelper echoClient2 (p2pInterfaces05.GetAddress(1),10);
...
//////// Your Code ////////
  ApplicationContainer serverApps3 = echoServer3.Install (p2pNodes.Get(6));
  serverApps3.Start (Seconds (1.0));
  serverApps3.Stop (Seconds (simTime));

//////// Your Code ////////
  UdpEchoClientHelper echoClient3 (p2pInterfaces06.GetAddress(1),11);
  echoClient3.SetAttribute ("MaxPackets", UintegerValue (3));
  echoClient3.SetAttribute ("Interval", TimeValue (Seconds (1.0)));
  echoClient3.SetAttribute ("PacketSize", UintegerValue (1024));

//////// Your Code ////////
  ApplicationContainer clientApps3 = echoClient3.Install (p2pNodes.Get(3));
